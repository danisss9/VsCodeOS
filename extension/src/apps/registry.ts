...
export const APPS: AppDescriptor[] = [
    ...
    },
    {
        ...
        icon: 'gear',
        command: 'vscodeos.settings.open',
        keywords: [
            'control panel', 'preferences', 'display', 'resolution', 'monitor',
            'keyboard', 'layout', 'sound', 'audio', 'microphone', 'storage',
            'disk', 'clean', 'update', 'upgrade', 'pacman', 'version',
        ],
    },
    {
        id: 'taskManager',
    ...
    },
    {
        ...
        description: "VS Code's own settings editor",
        icon: 'editor',
        command: 'workbench.action.openSettings',
        keywords: ['preferences', 'options', 'configure', 'json', 'vscode'],
    },
    {
        id: 'accessibility',
        title: 'Accessibility',
